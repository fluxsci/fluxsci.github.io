    ...
    <div class="content-width">
      <div class="signature-heading">
        ...
        <h2 id="signature-title">
          Your work stays connected.<br /><em>Down to the last detail.</em>
        </h2>
        <p>
          Refine a curve. Animate a result. Ask an agent to adjust a label.
          Flux understands the parts of your work, so the same plot can become
          a figure, a presentation, and a paper without losing its meaning.
        </p>
      </div>
      <div
        class="xray"
